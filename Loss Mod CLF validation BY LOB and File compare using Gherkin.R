...
tcid<-  inputs$args[5]
tpid<-  inputs$args[6]
#write.table(paste(resultdb,ValID,server,folder,tcid,tpid),
       #         file = "//qafile2/Leonardo/Feature Data/ValidationUnitetest_vasista/FinancialSensitivity/Unit test results/2.txt", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
# tcid<-  'ByLOBCLF_CLDLOBDB1'
# tpid<-  'ByLOBCLF_CLDLOBDB1'
