...
folder <- "///qafile2/Leonardo/Feature Data/SouthAMericaHotfix/Run1/RES_20151204165852/"      # path to folder that holds multiple .csv files
folder1<-"//qafile2/Leonardo/Feature Data/SouthAMericaHotfix/Run1/RES_20151204165852/CRFHIST.csv"
